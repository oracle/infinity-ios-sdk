Pod::Spec.new do |s|
  ...
  s.ios.frameworks = "Foundation", "UIKit", "CoreData", "SystemConfiguration", "Security", "CoreTelephony", "WebKit"
  
  s.source       = { :git => "https://github.com/webtrends/ios-sdk.git", :tag => "3.0.14" }
